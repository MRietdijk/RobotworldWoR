...
//		RobotWorld::getRobotWorld().newGoal( "Goal", wxPoint(850, 500),false); // @suppress("Avoid magic numbers")
	...
	void RobotWorld::makeWorldOne() {
		RobotWorld::getRobotWorld().newRobot( "Robot", wxPoint(163,111),false);
		RobotWorld::getRobotWorld().newWall( wxPoint(7,20), wxPoint(419,50) ,false);
		RobotWorld::getRobotWorld().newWall(wxPoint(20, 300), wxPoint(320, 500), false);
		RobotWorld::getRobotWorld().newWall(wxPoint(600, 300), wxPoint(400, 550), false);
		RobotWorld::getRobotWorld().newWall(wxPoint(800, 200), wxPoint(800, 800), false);
		RobotWorld::getRobotWorld().newGoal( "Goal", wxPoint(600,385),false);
